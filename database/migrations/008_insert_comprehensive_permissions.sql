...
-- Insert all permissions with proper categorization
...
('DASHBOARD_VIEW_COLLEGE', 'View College Dashboard', 'Access to college-specific dashboard with metrics', 'DASHBOARD', TRUE, NOW(), NOW()),
('DASHBOARD_VIEW_COUNSELOR', 'View Counselor Dashboard', 'Access to counselor dashboard with stats', 'DASHBOARD', TRUE, NOW(), NOW()),
('DASHBOARD_VIEW_SUBAGENT', 'View Sub-Agent Dashboard', 'Access to sub-agent dashboard with earnings', 'DASHBOARD', TRUE, NOW(), NOW()),
('DASHBOARD_VIEW_STUDENT', 'View Student Dashboard', 'Access to student dashboard with progress', 'DASHBOARD', TRUE, NOW(), NOW()),

-- ============================================
-- 2. LEAD MANAGEMENT PERMISSIONS (13)
-- ============================================
...
('AI_CALLING_VIEW_HISTORY', 'View AI Call History', 'Can view AI call logs and recordings', 'AI_CALLING', TRUE, NOW(), NOW()),
('AI_CALLING_VIEW_ANALYTICS', 'View AI Call Analytics', 'Can view AI call performance metrics', 'AI_CALLING', TRUE, NOW(), NOW()),

-- ============================================
-- 4. STUDENT MANAGEMENT PERMISSIONS (14)
-- ============================================
('STUDENT_VIEW_REFERRED', 'View Referred Students', 'Can view only referred students (sub-agents)', 'STUDENTS', TRUE, NOW(), NOW()),
...
-- ============================================
-- 5. APPLICATION MANAGEMENT PERMISSIONS (17)
-- ============================================
...
('APPLICATION_VIEW_OWN', 'View Own Applications', 'Can view own applications (students)', 'APPLICATIONS', TRUE, NOW(), NOW()),
...
-- ============================================
-- 6. COMMUNITY PERMISSIONS (5)
-- ============================================
('MENU_COMMUNITY', 'Access Community', 'Can access community features', 'COMMUNITY', TRUE, NOW(), NOW()),
('COMMUNITY_VIEW', 'View Community Posts', 'Can view community posts and discussions', 'COMMUNITY', TRUE, NOW(), NOW()),
('COMMUNITY_CREATE_POST', 'Create Community Posts', 'Can create new community posts', 'COMMUNITY', TRUE, NOW(), NOW()),
('COMMUNITY_COMMENT', 'Comment on Posts', 'Can comment on community posts', 'COMMUNITY', TRUE, NOW(), NOW()),
('COMMUNITY_MODERATE', 'Moderate Community', 'Can moderate and manage community content', 'COMMUNITY', TRUE, NOW(), NOW()),

-- ============================================
-- 7. COLLEGE MANAGEMENT PERMISSIONS (20)
-- ============================================
('MENU_COLLEGES', 'Access Colleges Menu', 'Can access colleges management section', 'COLLEGES', TRUE, NOW(), NOW()),
...
('COLLEGE_MANAGE_COURSES', 'Manage College Courses', 'Can add/edit/delete courses for college', 'COLLEGES', TRUE, NOW(), NOW()),
('COLLEGE_MANAGE_INTAKES', 'Manage College Intakes', 'Can manage intake dates and capacity', 'COLLEGES', TRUE, NOW(), NOW()),
('COLLEGE_VIEW_ANALYTICS', 'View College Analytics', 'Can view enrollment and application analytics', 'COLLEGES', TRUE, NOW(), NOW()),
('COLLEGE_VIEW_COMMISSION', 'View Commission Structure', 'Can view commission rates and structure', 'COLLEGES', TRUE, NOW(), NOW()),
('COLLEGE_MANAGE_DOCUMENTS', 'Manage College Documents', 'Can upload/manage college documents', 'COLLEGES', TRUE, NOW(), NOW()),
('COLLEGE_REVIEW_APPLICATIONS', 'Review College Applications', 'Can review applications for their college', 'COLLEGES', TRUE, NOW(), NOW()),
...
('COLLEGE_VIEW_PARTNERS', 'View College Partners', 'Can view partner agents and counselors', 'COLLEGES', TRUE, NOW(), NOW()),
...
('COLLEGE_VIEW_PUBLIC', 'View Public College Info', 'Can view public college information', 'COLLEGES', TRUE, NOW(), NOW()),
('COLLEGE_COMPARE', 'Compare Colleges', 'Can compare multiple colleges', 'COLLEGES', TRUE, NOW(), NOW()),

-- ============================================
-- 8. COURSE MANAGEMENT PERMISSIONS (6)
-- ============================================
('COURSE_SEARCH', 'Search Courses', 'Can search for courses', 'COURSES', TRUE, NOW(), NOW()),
('COURSE_VIEW_DETAILS', 'View Course Details', 'Can view detailed course information', 'COURSES', TRUE, NOW(), NOW()),
('COURSE_MANAGE_CURRICULUM', 'Manage Course Curriculum', 'Can manage course curriculum details', 'COURSES', TRUE, NOW(), NOW()),
...
('COURSE_VIEW_ANALYTICS', 'View Course Analytics', 'Can view course enrollment statistics', 'COURSES', TRUE, NOW(), NOW()),

-- ============================================
-- 9. PARTNERS MANAGEMENT PERMISSIONS (8)
-- ============================================
('MENU_PARTNERS', 'Access Partners Menu', 'Can access partners management section', 'PARTNERS', TRUE, NOW(), NOW()),
('PARTNER_VIEW_ALL', 'View All Partners', 'Can view all partner records', 'PARTNERS', TRUE, NOW(), NOW()),
('PARTNER_CREATE', 'Create Partners', 'Can add new partner organizations', 'PARTNERS', TRUE, NOW(), NOW()),
('PARTNER_EDIT', 'Edit Partners', 'Can edit partner information', 'PARTNERS', TRUE, NOW(), NOW()),
('PARTNER_DELETE', 'Delete Partners', 'Can remove partners', 'PARTNERS', TRUE, NOW(), NOW()),
('PARTNER_VIEW_PERFORMANCE', 'View Partner Performance', 'Can view partner performance metrics', 'PARTNERS', TRUE, NOW(), NOW()),
('PARTNER_MANAGE_COMMISSION', 'Manage Partner Commission', 'Can set partner commission rates', 'PARTNERS', TRUE, NOW(), NOW()),
('PARTNER_VIEW_PAYMENTS', 'View Partner Payments', 'Can view partner payment history', 'PARTNERS', TRUE, NOW(), NOW()),

-- ============================================
-- 10. MARKETING PERMISSIONS (10)
-- ============================================
('MENU_MARKETING', 'Access Marketing Menu', 'Can access marketing section', 'MARKETING', TRUE, NOW(), NOW()),
('MARKETING_VIEW', 'View Marketing Campaigns', 'Can view marketing campaigns', 'MARKETING', TRUE, NOW(), NOW()),
('MARKETING_CREATE', 'Create Marketing Campaigns', 'Can create new campaigns', 'MARKETING', TRUE, NOW(), NOW()),
...
('MARKETING_MANAGE_WEBINARS', 'Manage Webinars', 'Can create and manage webinars', 'MARKETING', TRUE, NOW(), NOW()),
('MARKETING_MANAGE_EVENTS', 'Manage Events', 'Can create and manage events', 'MARKETING', TRUE, NOW(), NOW()),
('MARKETING_MANAGE_CONTENT', 'Manage Marketing Content', 'Can manage marketing content', 'MARKETING', TRUE, NOW(), NOW()),
('MARKETING_VIEW_BUDGET', 'View Marketing Budget', 'Can view marketing budget and expenses', 'MARKETING', TRUE, NOW(), NOW()),

-- ============================================
-- 11. FINANCE PERMISSIONS (12)
-- ============================================
('MENU_FINANCE', 'Access Finance Menu', 'Can access finance section', 'FINANCE', TRUE, NOW(), NOW()),
('FINANCE_VIEW_ALL', 'View All Transactions', 'Can view all financial transactions', 'FINANCE', TRUE, NOW(), NOW()),
('FINANCE_VIEW_OWN_COMMISSIONS', 'View Own Commissions', 'Can view own commission earnings', 'FINANCE', TRUE, NOW(), NOW()),
...
('FINANCE_EDIT_INVOICE', 'Edit Invoices', 'Can edit invoice details', 'FINANCE', TRUE, NOW(), NOW()),
('FINANCE_APPROVE_INVOICE', 'Approve Invoices', 'Can approve invoice payments', 'FINANCE', TRUE, NOW(), NOW()),
('FINANCE_MANAGE_EXPENSES', 'Manage Expenses', 'Can add and manage expenses', 'FINANCE', TRUE, NOW(), NOW()),
('FINANCE_VIEW_REPORTS', 'View Financial Reports', 'Can view financial reports and statements', 'FINANCE', TRUE, NOW(), NOW()),
('FINANCE_EXPORT_DATA', 'Export Financial Data', 'Can export financial data', 'FINANCE', TRUE, NOW(), NOW()),
('FINANCE_MANAGE_PAYMENTS', 'Manage Payments', 'Can process and manage payments', 'FINANCE', TRUE, NOW(), NOW()),
('FINANCE_VIEW_ANALYTICS', 'View Financial Analytics', 'Can view financial analytics dashboard', 'FINANCE', TRUE, NOW(), NOW()),

-- ============================================
-- 12. HR PERMISSIONS (8)
-- ============================================
('MENU_HR', 'Access HR Menu', 'Can access HR management section', 'HR', TRUE, NOW(), NOW()),
('HR_VIEW_ALL', 'View All HR Records', 'Can view all employee records', 'HR', TRUE, NOW(), NOW()),
('HR_MANAGE_LEAVE', 'Manage Leave', 'Can manage leave requests and approvals', 'HR', TRUE, NOW(), NOW()),
...
('HR_MANAGE_TRAINING', 'Manage Training', 'Can manage training programs and records', 'HR', TRUE, NOW(), NOW()),
('HR_VIEW_PAYROLL', 'View Payroll', 'Can view payroll information', 'HR', TRUE, NOW(), NOW()),
('HR_MANAGE_DOCUMENTS', 'Manage HR Documents', 'Can manage employee documents', 'HR', TRUE, NOW(), NOW()),

-- ============================================
-- 13. ASSETS MANAGEMENT PERMISSIONS (6)
-- ============================================
('MENU_ASSETS', 'Access Assets Menu', 'Can access assets management section', 'ASSETS', TRUE, NOW(), NOW()),
...
('ASSET_EDIT', 'Edit Assets', 'Can edit asset information', 'ASSETS', TRUE, NOW(), NOW()),
...
-- ============================================
-- 14. REPORTS & ANALYTICS PERMISSIONS (11)
-- ============================================
('MENU_REPORTS', 'Access Reports Menu', 'Can access reports section', 'REPORTS', TRUE, NOW(), NOW()),
('REPORT_VIEW_COLLEGE', 'View College Reports', 'Can view college-specific reports', 'REPORTS', TRUE, NOW(), NOW()),
('REPORT_VIEW_COUNSELOR', 'View Counselor Reports', 'Can view counselor performance reports', 'REPORTS', TRUE, NOW(), NOW()),
('REPORT_VIEW_SUBAGENT', 'View Sub-Agent Reports', 'Can view sub-agent performance reports', 'REPORTS', TRUE, NOW(), NOW()),
('REPORT_EXPORT_ALL', 'Export All Reports', 'Can export any report type', 'REPORTS', TRUE, NOW(), NOW()),
...
-- ============================================
-- 15. ROLES & PERMISSIONS MANAGEMENT (9)
-- ============================================
('MENU_ROLES_PERMISSIONS', 'Access Roles & Permissions', 'Can access roles and permissions section', 'ROLES', TRUE, NOW(), NOW()),
...
('PERMISSION_ASSIGN_TO_MULTIPLE', 'Bulk Assign Permissions', 'Can assign permissions to multiple users/roles', 'ROLES', TRUE, NOW(), NOW()),
('ROLE_MANAGE_HIERARCHY', 'Manage Role Hierarchy', 'Can manage role inheritance and hierarchy', 'ROLES', TRUE, NOW(), NOW()),

-- ============================================
-- 16. COMMUNICATION PERMISSIONS (5)
-- ============================================
('COMMUNICATION_SEND_BULK', 'Send Bulk Messages', 'Can send bulk emails/SMS', 'COMMUNICATION', TRUE, NOW(), NOW()),
('COMMUNICATION_MANAGE_TEMPLATES', 'Manage Communication Templates', 'Can create and manage message templates', 'COMMUNICATION', TRUE, NOW(), NOW()),
('COMMUNICATION_SCHEDULE', 'Schedule Communications', 'Can schedule future communications', 'COMMUNICATION', TRUE, NOW(), NOW()),
('COMMUNICATION_VIEW_ANALYTICS', 'View Communication Analytics', 'Can view communication metrics', 'COMMUNICATION', TRUE, NOW(), NOW()),
('COMMUNICATION_MANAGE_PREFERENCES', 'Manage Communication Preferences', 'Can manage user communication preferences', 'COMMUNICATION', TRUE, NOW(), NOW()),

-- ============================================
-- 17. SETTINGS PERMISSIONS (5)
-- ============================================
('SETTINGS_VIEW_ALL', 'View System Settings', 'Can view all system settings', 'SETTINGS', TRUE, NOW(), NOW()),
...
-- ============================================
-- 18. PROFILE & ACCOUNT PERMISSIONS (6)
-- ============================================
('PROFILE_VIEW_OWN', 'View Own Profile', 'Can view own profile information', 'PROFILE', TRUE, NOW(), NOW()),
('PROFILE_EDIT_OWN', 'Edit Own Profile', 'Can edit own profile details', 'PROFILE', TRUE, NOW(), NOW()),
('PROFILE_UPLOAD_DOCUMENTS', 'Upload Profile Documents', 'Can upload documents to own profile', 'PROFILE', TRUE, NOW(), NOW()),
...
('PROFILE_MANAGE_NOTIFICATIONS', 'Manage Notification Settings', 'Can manage own notification preferences', 'PROFILE', TRUE, NOW(), NOW())
